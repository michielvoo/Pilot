@{
    ...
    FileList = @(
        ...
        "Invoke/Invoke-Git/Invoke-Git.ps1"
        "Invoke/Invoke-Git/Invoke-GitBranchList.ps1"
        "Invoke/Invoke-Git/Invoke-GitDescribe.ps1"
        "Invoke/Invoke-NativeCommand.ps1"
        "Invoke/Invoke.psm1"
        "Pathfinder/Get-CanonicalPath.ps1"
        "Pathfinder/Pathfinder.psm1"
        "Private/Get-CurrentGitBranch.ps1"
        "Private/Get-CurrentGitTag.ps1"
        "Private/Get-CurrentGitVersionTagOrBranch.ps1"
        "Private/Get-UnixTimestamp.ps1"
        "License.txt"
        "Pilot.psd1"
        "Pilot.psm1"
